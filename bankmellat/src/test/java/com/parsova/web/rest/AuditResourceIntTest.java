...
import com.parsova.BankmellatApp;
import com.parsova.config.audit.AuditEventConverter;
import com.parsova.domain.PersistentAuditEvent;
import com.parsova.repository.PersistenceAuditEventRepository;
import com.parsova.service.AuditEventService;
...
@SpringBootTest(classes = BankmellatApp.class)
@Transactional
